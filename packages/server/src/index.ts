...
import * as automaticSpeechRecognitionRouteModule from "./routes/tasks/automatic-speech-recognition.ts"
import * as imageToImageRouteModule from "./routes/tasks/image-to-image.ts"
import * as textToSpeechRouteModule from "./routes/tasks/text-to-speech.ts"
