import { AudioLines, Bot, Boxes, Image as ImageIcon, MessageSquare, Sparkles } from "lucide-react"
...
export type ViewId = "agent" | "text-generation" | "image-to-image" | "text-to-audio" | "models"
